...
if (($arCurrentValues['USE_SHARE'] ?? 'N') === 'Y')
{
    ...
    $arComponentParameters = [
        "PARAMETERS" => [
            "PAGE_TITLE" => [
                "PARENT" => "BASE", // Категория, в которой будет отображаться параметр
                "NAME" => "Заголовок страницы", // Название параметра в интерфейсе
                "TYPE" => "STRING", // Тип параметра (строка)
                "DEFAULT" => "Объявления", // Значение по умолчанию
            ],
            "FILTER_BY_USER" => [
                "PARENT" => "BASE",
                "NAME" => "Фильтровать по ID пользователя", // Параметр для фильтрации
                "TYPE" => "CHECKBOX", // Тип параметра (чекбокс, булево значение)
                "DEFAULT" => "Y", // Значение по умолчанию: включено
            ],
        ],
    ];
}
